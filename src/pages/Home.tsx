    ...
    <article>
      ...
      {data && (
        <>
          ...
          <h3>Correcting wages for industrial composition</h3>
          <p>
            It may be that a city experiences a labor demand boom, but
            one concentrated in low-wage jobs. As new workers migrate in
            to take advantage of that opportunity, the city's average
            wage mechanically moves down. Ideally, one would calculate a
            wage premium by regressing an individual's wage on a series
            of controls — including city, occupation, industry,
            experience, sex, and education. Here we are able to control
            for industrial composition by regressing log wages on
            industry and city. We visualize this below, where the y axis
            is the growth rate of the wage premium generated by that
            regression between 2014 and 2024.{' '}
            <CityLink name="Marrakesh" />, which originally showed
            below-median wage growth, now moves above the line — arguing
            that it has in fact seen a positive labor demand shock.{' '}
            <CityLink name="Tangier" /> also moves to just above the
            line, giving a similar signal. By accounting for industrial
            composition, the wage premium generates a stronger diagnostic
            signal. The trade-off is that it is a more complicated metric
            to explain.
          </p>
          <div className="chart-block">
            <h4>Net migration vs. wage-premium growth</h4>
            <p className="chart-caption">
              Each point is one city. The y axis is the annualized
              change, 2014–2024, in the city's wage premium from a
              two-way (city + industry) regression of log wages; zero
              means the city kept pace with the national rate for its
              industry mix.
            </p>
          ...
          <div className="chart-block">
            ...
            <p className="chart-caption">
              ...
              wage CAGR or composition-adjusted wage-premium growth.
              Dashed lines mark the national norm on each axis.
            </p>
